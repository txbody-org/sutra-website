...
import { Github, MessageCircle, Twitter, ArrowRight } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-slate-700/50 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <div className="text-slate-400 text-sm mb-4 sm:mb-0 font-body">
            © 2025{" "}
            <span className="text-slate-300 font-medium">SUTRA SDK</span>. Built
            with ❤️ for the Elixir community.
          </div>
