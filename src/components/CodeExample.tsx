...
const CodeExample = () => {
  ...
  const { copied: copiedMain, copyToClipboard: copyMain } = useCopyToClipboard();
  const { copied: copiedTest, copyToClipboard: copyTest } = useCopyToClipboard();
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-display font-extrabold text-white mb-6 leading-tight tracking-tight">
            Code that
            <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent"> just works</span>
          </h2>
          <p className="text-base sm:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed font-body">
            Write clean, readable code that your team will love. Elixir's functional approach makes blockchain development predictable and maintainable.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <CardHeader className="bg-slate-800/50 border-b border-slate-700">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <CardTitle className="text-white text-base sm:text-lg font-display font-semibold tracking-wide">Transaction Building</CardTitle>
                </div>
                <div className="flex items-center space-x-2 self-start sm:self-auto">
                  ...
                  >
                    {copiedMain ? <Check className="h-4 w-4 text-green-400" /> : <Copy className="h-4 w-4" />}
                  </Button>
                </div>
              </div>
            </CardHeader>
            <CardContent className="p-0">
              <pre className="text-xs sm:text-sm text-slate-300 p-4 sm:p-6 overflow-x-auto font-code">
                <code className="font-code">{codeExample}</code>
              </pre>
            </CardContent>
          </Card>
          ...
          <Card className="animate-on-scroll fade-right card-enhanced card-code overflow-hidden">
            <CardHeader className="bg-slate-800/50 border-b border-slate-700">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  ...
                  <CardTitle className="text-white text-base sm:text-lg font-display font-semibold tracking-wide">E2E Testing</CardTitle>
                </div>
                <div className="flex items-center space-x-2 self-start sm:self-auto">
                  ...
                  >
                    {copiedTest ? <Check className="h-4 w-4 text-green-400" /> : <Copy className="h-4 w-4" />}
                  </Button>
                </div>
              </div>
            </CardHeader>
            <CardContent className="p-0">
              <pre className="text-xs sm:text-sm text-slate-300 p-4 sm:p-6 overflow-x-auto font-code">
                <code className="font-code">{testExample}</code>
              </pre>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <div className="animate-on-scroll scale-in flex flex-col sm:inline-flex sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 bg-slate-800/50 rounded-lg p-4 sm:p-5 border border-slate-700">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <span className="text-slate-300 text-sm sm:text-base font-medium tracking-wide">Multi-Chain SDK</span>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="w-3 h-3 bg-blue-400 rounded-full"></div>
              <span className="text-slate-300 font-mono text-sm sm:text-base">BEAM Powered</span>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="w-3 h-3 bg-purple-400 rounded-full"></div>
              <span className="text-slate-300 text-sm sm:text-base font-medium tracking-wide">Elixir Native</span>
            </div>
          </div>
        </div>
      </div>
