            ...
            `,
				...
				<div className='relative max-w-xs sm:max-w-4xl mx-auto text-center z-20'>
					...
					>
						...
						Elixir SDK for UTXO Blockchains
					...
					<h1
						className='text-xl sm:text-2xl md:text-4xl lg:text-5xl font-display font-extrabold text-white mb-5 sm:mb-6 md:mb-8 leading-tight tracking-tight animate-slide-up opacity-0'
					...
					>
						...
						UTXO-based blockchains. Leverage the BEAM virtual machine to create
						robust, concurrent blockchain applications.
					</p>
